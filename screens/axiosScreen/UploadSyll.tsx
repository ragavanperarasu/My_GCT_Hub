...
type SubShowScreenProp = StackNavigationProp<RootStackParamList, 'UploadSyll'>;

export default function UploadSyll({route}: {route: SubShowScreenProp}) {
    ...
    <View style={{ flex: 1 }}>
      <ScrollView style={styles.scroll}>
        <View style={styles.center}>
          ...
          <Text style={styles.header}>Semester Syllabus</Text>
