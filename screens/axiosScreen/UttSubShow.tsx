...
type SubShowScreenProp = StackNavigationProp<RootStackParamList, "UttSubShow">;


export default function UttSubShow({route}:{route: SubShowScreenProp}) {
  ...
  await notifee.displayNotification({
    ...
    body: 'Your Uint Test Two Question PDF Deleted Successfully',
    android: {
      channelId: 'default',
  ...
  <TouchableOpacity
    style={{ marginLeft: 15 }}
    onPress={() =>
      navigation.navigate('UploadUttqus', { subname: i.subname })
    }>
    ...
    {expandedSubject === outerIndex && i.uttqus?.map((j, innerIndex) => (
