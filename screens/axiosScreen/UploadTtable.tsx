...
type SubShowScreenProp = StackNavigationProp<RootStackParamList, 'UploadTtable'>;

export default function UploadTtable({route}: {route: SubShowScreenProp}) {
    ...
    <View style={{ flex: 1 }}>
      <ScrollView style={styles.scroll}>
        <View style={styles.center}>
          ...
          <Text style={styles.header}>Semester Timetable</Text>
