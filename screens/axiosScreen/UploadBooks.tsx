...
type SubShowScreenProp = StackNavigationProp<RootStackParamList, 'UploadBooks'>;

export default function UploadBooks({route}: {route: SubShowScreenProp}) {
    ...
    <View style={{ flex: 1 }}>
      <ScrollView style={styles.scroll}>
        <View style={styles.center}>
          ...
          <Text style={styles.header}>Semester Books</Text>
