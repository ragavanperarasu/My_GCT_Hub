...
const UPLOAD_UTO_POST = "/utoupl22"
...
type SubShowScreenProp = StackNavigationProp<RootStackParamList, 'UploadUtoqus'>;

export default function UploadUtoqus({route}: {route: SubShowScreenProp}) {
...
const handleUpload = async () => {
  ...
  try {
    const url = API_URL + UPLOAD_UTO_POST;
    ...
    <View style={{ flex: 1 }}>
      <ScrollView style={styles.scroll}>
        <View style={styles.center}>
          ...
          <Text style={styles.header}>Unit Test 1 Previous Year</Text>
