...
import {Dialog, Portal, Button, Text, PaperProvider} from 'react-native-paper';
...
function App() {
  ...
  return (
    <PaperProvider>
      <Portal>
        <Dialog visible={exitVisible} style={{backgroundColor: '#F7F7F7'}}>
          <Dialog.Title
            style={{color: '#6F2DA8', textAlign: 'center', fontWeight: 700}}>
          ...
          <Dialog.Content>
            <Text
              ...
              Kindly Enable Notifications to Receive Important News, Updates,
              and Posts from the MyGCT App.
            </Text>
          </Dialog.Content>
